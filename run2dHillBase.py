...
def main(template0, target0, hillName, AR, r, x, Ls, L, L1, H, x0, z0, us, yM, caseType):
	...
	plotMartinez = 1
	hSample = 10
	fac = 3 # currecting calculation of number of cells and Rx factor to get a smooth transition 
